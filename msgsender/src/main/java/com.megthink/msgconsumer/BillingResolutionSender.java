...
@Service
public class BillingResolutionSender {
	@Autowired
	private KafkaProducer producer;

    private static final Logger logger = LoggerFactory.getLogger(BillingResolutionSender.class);
    private final String recipientUrl = ReadConfigFile.getProperties().getProperty("RecipientUrl");
    ...
    @Value("kafka.topic")
    private static final String QUEUE = ReadConfigFile.getProperties().getProperty("Billing_Resolution_queue");
    @Value("kafka.group-id")
    private static final String group_id = ReadConfigFile.getProperties().getProperty("Billing_Resolution_queue_groupid");
    ...
    public void sendConfirmation(String message) {
        ...
        try {
            ...
            if (recipient!=null&&recipientUrl!=null) {
            	...
            	logger.info("recipient and recipientUrl contains null value or coming receiver is null in Billing_ResolutionSender");
            }
        } catch (Exception e) {
