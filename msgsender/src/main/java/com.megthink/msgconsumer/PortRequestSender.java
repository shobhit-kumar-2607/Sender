...
@Service
public class PortRequestSender {
	@Autowired
	private KafkaProducer producer;

    private static final Logger logger = LoggerFactory.getLogger(PortRequestSender.class);
   ...
   // @Value("kafka.topic")
    private static final String queue = ReadConfigFile.getProperties().getProperty("PortRequestSender_queue");
  //  @Value("kafka.group-id")
    private static final String group_id = ReadConfigFile.getProperties().getProperty("PortRequestSender_groupid");
 ...
 //   @KafkaListener(topics = "${OUTQUEUE}", groupId = "${kafka.group-id}")
    @KafkaListener(topics ="OUTQUEUE", groupId="group_id")
