...
@Service
public class NumberReturnSender {
	@Autowired
	private KafkaProducer producer;

    private static final Logger logger = LoggerFactory.getLogger(NumberReturnSender.class);
    ...
    @Value("kafka.topic")
    private static final String QUEUE = ReadConfigFile.getProperties().getProperty("NumberReturnSender_queue");
    @Value("kafka.group-id")
    private static final String group_id = ReadConfigFile.getProperties().getProperty("NumberReturnSender_groupid");
